package com.pt.manage.job.notification;

import com.pt.manage.repository.booking.BookingEntity;
import com.pt.manage.repository.booking.BookingStatus;
import com.pt.manage.repository.notification.NotificationEntity;
import com.pt.manage.repository.notification.NotificationEvent;
import com.pt.manage.repository.notification.NotificationModelMapper;
...
public class SendNotificationBeforeClassJobConfig {
    ...
    public Step addNotificationStep() {
        return this.stepBuilderFactory.get("addNotificationStep")
                .<BookingEntity, NotificationEntity>chunk(CHUNK_SIZE) // <input , output> 순서
